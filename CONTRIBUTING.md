...
* [open an issue](https://github.com/GoogleChromeLabs/wp-reporting-api/issues/new)
...
* push the changes to your fork and [submit a pull request](https://github.com/GoogleChromeLabs/wp-reporting-api/compare) to the `master` branch
...
* visit our project on [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/reporting-api) and sign in with your wordpress.org account (create one if you haven't yet)
