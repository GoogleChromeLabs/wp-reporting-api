...
* [open an issue](https://github.com/felixarntz/wp-reporting-api/issues/new)
...
* push the changes to your fork and [submit a pull request](https://github.com/felixarntz/wp-reporting-api/compare) to the `master` branch
